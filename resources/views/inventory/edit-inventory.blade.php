                            ...
                            <form action="{{ route('update-inventory', ['id' => $selected->id]) }}" method="post" class="php-email-form">
                                ...
                                <div class="form-group mt-3 mb-3">
                                    ...
                                    <select class="form-control" name="kategori" id="kategori" required>
                                        ...
                                        <option value="Sepatu" {{ $selected->kategori == "MERAH" ? 'selected' : '' }}>MERAH</option>
                                        <option value="Baju" {{ $selected->kategori == "PUTIH" ? 'selected' : '' }}>PUTIH</option>
                                        <option value="Elektronik" {{ $selected->kategori == "raskin" ? 'selected' : '' }}>raskin</option>
                                        <option value="Mainan" {{ $selected->kategori == "bansos" ? 'selected' : '' }}>bansos</option>
                                    </select>
                                </div>
                                <div class="form-group mt-3 mb-3">
